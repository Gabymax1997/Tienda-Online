...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Tieda Online">
        ...
        <div class="row py-3 border-bottom">
            ...
            <div class="search-bar row bg-light p-2 my-2 rounded-4">
              ...
              <div class="col-11 col-md-7">
                <form id="search-form" class="text-center" action="index.html" method="post">
                  <input type="text" class="form-control border-0 bg-transparent" placeholder="+ de 20.000 productos" />
                </form>
              </div>
              <div class="col-1">
          ...
          <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
            <div class="support-box text-end d-none d-xl-block">
              <span class="fs-6 text-muted">Necesitas ayuda?</span>
            ...
            <div class="cart text-end d-none d-lg-block dropdown">
              <button class="border-0 bg-transparent d-flex flex-column gap-2 lh-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart" aria-controls="offcanvasCart">
                ...
                <span class="cart-total fs-5 fw-bold">$1.000,59</span>
              </button>
            </div>
          </div>
                ...
                <div class="offcanvas-body">
                  ...
                  <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                    <li class="nav-item active">
                      <a href="#women" class="nav-link">Mujer</a>
                    </li>
                    <li class="nav-item dropdown">
                      <a href="#men" class="nav-link">Hombre</a>
                    </li>
                    <li class="nav-item">
                      <a href="#kids" class="nav-link">Niños</a>
                    </li>
                    <li class="nav-item">
                      <a href="#accessories" class="nav-link">Accesorios</a>
                    </li>
                    <li class="nav-item dropdown">
                      <a class="nav-link dropdown-toggle" role="button" id="pages" data-bs-toggle="dropdown" aria-expanded="false">Pages</a>
                      <ul class="dropdown-menu" aria-labelledby="pages">
                        <li><a href="index.html" class="dropdown-item">Sobre Nosotros </a></li>
                        <li><a href="index.html" class="dropdown-item">Tienda </a></li>
                        <li><a href="index.html" class="dropdown-item">1 Producto </a></li>
                        <li><a href="index.html" class="dropdown-item">Carrito </a></li>
                        <li><a href="index.html" class="dropdown-item">Checkout </a></li>
                        <li><a href="index.html" class="dropdown-item">Blog </a></li>
                        <li><a href="index.html" class="dropdown-item">Post </a></li>
                        <li><a href="index.html" class="dropdown-item">Styles </a></li>
                        <li><a href="index.html" class="dropdown-item">Contact </a></li>
                        <li><a href="index.html" class="dropdown-item">Gracias! </a></li>
                        <li><a href="index.html" class="dropdown-item">Cuenta </a></li>
                        <li><a href="index.html" class="dropdown-item">Ups ha ocurrido un problema! </a></li>
                      </ul>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a href="#sale" class="nav-link">Venta</a>
                    </li>
                    <li class="nav-item">
                  ...
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          ...
                          <h3 class="display-4">Jugos y Licuados</h3>
                          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dignissim massa diam elementum.</p>
                          <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1 px-4 py-3 mt-3">Compra ahora</a>
                        </div>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          ...
                          <h3 class="banner-title">Jugos y Licuados</h3>
                          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dignissim massa diam elementum.</p>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          <div class="categories mb-3 pb-3">100% natural</div>
                          <h3 class="banner-title">Harinas Aderezos</h3>
                          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dignissim massa diam elementum.</p>
                          <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">Shop Collection</a>
                        </div>
                        <div class="img-wrapper col-md-5">
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('images/ad-image-1.png') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
                  ...
                  <div class="content-wrapper col-md-7">
                    ...
                    <h3 class="banner-title">Frutas y Vegetales</h3>
                    <a href="#" class="d-flex align-items-center nav-link">Colección <svg width="24" height="24"><use xlink:href="#arrow-right"></use></svg></a>
                  </div>
              ...
              <div class="banner-ad bg-danger block-3" style="background:url('images/ad-image-2.png') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
                  ...
                  <div class="content-wrapper col-md-7">
                    ...
                    <h3 class="item-title">Panificados</h3>
                    <a href="#" class="d-flex align-items-center nav-link">Colección <svg width="24" height="24"><use xlink:href="#arrow-right"></use></svg></a>
                  </div>
          ...
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between mb-5">
              ...
              <div class="d-flex align-items-center">
                <a href="#" class="btn-link text-decoration-none">Ver todas ls categorias →</a>
            ...
            <div class="category-carousel swiper">
              <div class="swiper-wrapper">
                <a href="index.html" class="nav-link category-item swiper-slide">
                  ...
                  <h3 class="category-title">Frutas y Vegetales</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
